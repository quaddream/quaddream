...
const AdminEnquiry = () => {
    ...
    useEffect(() => {
        ...
        const fetchEnquiriesData = async () => {
            try {
                const response = await fetch(`/api/admin/careers/enquiry?page=${page}&limit=10`);
    ...
    const handleBulkDelete = async () => {
        ...
        try {
            const response = await fetch(`/api/admin/careers/bulk-delete`, {
                method: "POST",
                headers: {
                                                ...
                                                <div className="p-5 flex flex-col gap-5 relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                                    ...
                                                    <div className="grid grid-cols-1 gap-4 text-sm h-[300px] overflow-auto">
                                                        ...
                                                        <div className="flex flex-col">
                                                            ...
                                                            <span className="text-gray-900">{selectedEnquiry.firstName}</span>
                                                        </div>
                                                        ...
                                                        <div className="flex flex-col">
                                                            <label className="font-semibold text-gray-600">Nationality</label>
                                                            <span className="text-gray-900">{selectedEnquiry.nationality}</span>
                                                        </div>

                                                        <div className="flex flex-col">
                                                            <label className="font-semibold text-gray-600">Current Location</label>
                                                            <span className="text-gray-900">{selectedEnquiry.currentLocation}</span>
                                                        </div>

                                                        <div className="flex flex-col">
                                                            <label className="font-semibold text-gray-600">Applied For</label>
                                                        ...
                                                        <div className="flex gap-3 items-center">
                                                            ...
                                                            <Link href={selectedEnquiry.resume} target='_blank'><FaFileAlt /></Link>
                                                            {/* <span className="text-gray-900">{selectedEnquiry.resume}</span> */}
                                                        </div>                                                       
