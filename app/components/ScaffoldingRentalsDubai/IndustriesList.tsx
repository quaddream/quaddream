  ...
  return (
              ...
              >
                ...
                <div
                  className={`absolute inset-0 z-0 transition-opacity duration-500 ${
                    isActive ? "opacity-100 scale-105" : "opacity-0 scale-100 group-hover:opacity-100 group-hover:scale-105"
                ...
                <div
                  className={`absolute top-[50%] left-0 h-[2px] bg-white z-40 transition-all duration-500 ease-in-out ${
                ...
                {/* Arrow circle */}
                <div
                  className={`absolute top-[50%] -translate-y-1/2 w-[51px] h-[51px] bg-white rounded-full z-40 flex items-center justify-center transition-all duration-500 ease-out ${
                    isActive
    ...
    />
                ...
                <div className="px-[30px] 2xl:pt-[33.3px] pb-6 2xl:pb-[28px] relative z-10">
                  <h3
                    className={`text-2xl leading-[1.3] font-medium transition-colors duration-300 max-w-[15ch] ${
