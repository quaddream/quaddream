        ...
        <div className="container">
          {title && (
            <div>
              ...
              {!isFaq && (
                <motion.h1
                  className="text-white text-75 leading-[1.07] pb-4 md:pb-12 font-normal inline-block max-w-[24ch]"
                  initial={{
                    opacity: 0,
                    x: -50,
              ...
              >
                <button
                  onClick={(e) => {
                    ...
                    if (element) {
                      const offset = window.innerWidth < 768 ? 25 : 120;
                      const top =
                  ...
                  className="fade-item flex items-center gap-2 cursor-pointer text-16 border-1 border-white py-1 2xl:py-[10px] px-3 2xl:px-5 rounded-[60px] w-fit text-white relative group overflow-hidden z-20 isolation-isolate fade-item"
                >
