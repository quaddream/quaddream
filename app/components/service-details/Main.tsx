  ...
  return ( 
    <section className="py-150 rounded-t-2xl xl:rounded-t-[100px] relative z-[50] mt-[-4.5%] bg-white">
      <div className="container">
        ...
        <Image src={serviceDetails.firstSection.image} alt="" width={1920} height={1280} className="object-cover w-full mb-5 lg:mb-8 2xl:mb-12 h-[400px] xl:h-[601px]  rounded-2xl" />
        {
          serviceDetails.firstSection.description.map((item, index) => (
            <p key={index} className="mb-0 text-19 leading-text19">{item}</p>
          ))
        }
      </div>
    </section>
