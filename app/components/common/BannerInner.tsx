...
//               initial={{ scaleX: 0 }}
//               animate={{ scaleX: 1 }}
//               transition={{ duration: 1, ease: "easeOut", delay: 1 }} // starts after text
//               style={{ transformOrigin: "left center" }}
//             />
//           </div>
//           )}

//           <div className={`  pb-3 lg:pb-15 xl:pb-19 ${bannerData[0].title ? 'pt-5 lg:pt-16 xl:pt-16 2xl:pt-[135px] ' : ''}`}>
...
import Link from "next/link";
import { motion } from "framer-motion";
import { QhseData } from "../qhse/type";
...
type BannerProps = {
  bannerData: QhseData["bannerSection"];
};
