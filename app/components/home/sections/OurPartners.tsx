  ...
  return (
    <section className="pt-150 bg-[#F9F9F9] swiper-partners relative z-[50] overflow-hidden">
      ...
      <Image
        ...
        width={2000}
        height={1000}
        className="h-full absolute w-auto object-cover bottom-0 right-0 lg:right-[30px] z-0"
      />
      )}
                ...
                <motion.div className="flex gap-4 flex-col" variants={moveUp(i * 0.2)} initial="hidden" whileInView="show"
                 transition={{duration: 0.6}} viewport={{amount: 0.1, once: true}}>
                  <div className="ml-[20px] xl:ml-[85px] mr-[20px] xl:mr-0">
                    <Image src={first.src} alt={first.alt} width={200} height={100} className="object-contain h-[100px] w-auto" />
                  </div>
                  <div className="border-t border-lite-gray" />
                  {second && (
                    <div className="ml-[20px] xl:ml-[85px] mr-[20px] xl:mr-0">
                      <Image src={second.src} alt={second.alt} width={200} height={100} className="object-contain h-[100px] w-auto" />
                    </div>
                  )}
                </motion.div>
              </SwiperSlide>
