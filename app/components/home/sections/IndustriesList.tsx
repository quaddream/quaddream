...
<motion.p variants={moveUp(0.2)} initial="hidden" whileInView="show" transition={{duration: 0.6}} viewport={{amount: 0.1, once: true}} className="text-19 leading-[1.684210526315789] text-foreground mb-4 lg:mb-7 max-w-[100ch]">Industries have unique safety, load, and structural requirements. Quad Dream Group provides scaffolding solutions
designed for diverse projects across the UAE. </motion.p>
