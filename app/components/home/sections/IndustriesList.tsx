    ...
    <section className="py-150 bg-white">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-[1px] relative">
          <div className="absolute top-[50%] left-0 translate-y-[-50%] h-[0.5px] w-full bg-black z-40"></div>
              ...
              <div className="absolute top-[50%] translate-y-[-50%] left-0 w-[51px] h-[51px] bg-white rounded-full
               z-40 opacity-0 group-hover:opacity-100 group-hover:left-[75%] transition-all duration-500 flex items-center justify-center">
                <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M14.9283 6.32861L21.0144 12.3986L14.9283 18.4686" stroke="#FF0000" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M3.96924 12.3979H20.8437" stroke="#FF0000" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
              </div>
