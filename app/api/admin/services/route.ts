...
export async function PATCH(request: NextRequest) {
  try {
    ...
    if (id) {
      ...
      foundService.firstSection.items = body.firstSection.items;
      ...
      foundService.firstSection.items = body.firstSection.items;
      foundService.secondSection.items = body.secondSection.items;
      foundService.thirdSection = body.thirdSection;
      foundService.thirdSection.items = body.thirdSection.items;
      foundService.fifthSection = body.fifthSection;
      foundService.fifthSection.items = body.fifthSection.items;
      foundService.sixthSection = body.sixthSection;
